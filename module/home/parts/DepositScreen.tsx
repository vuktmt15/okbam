...
export default function DepositScreen({
  ...
  const depositAddress =
    userDetails?.address || "0xddbed71fc5e194081ec1914fad8971b8...";
      ...
      <div className="deposit-content">
        ...
        <div className="deposit-info">
          <div className="info-text">
            1. Copy the address above or scan the QR code and select BNB Smart
            Chain (BEP20) network to deposit.
          </div>
          <div className="info-text">2. Minimum deposit 10$</div>
          <div className="info-text">3. Estimated 1 minute</div>
        </div>
        ...
        <div className="network-overlay" onClick={() => setShowNetworks(false)}>
          <div className="sheet" onClick={(e) => e.stopPropagation()}>
            ...
            >
              ...
              <div className="desc">
                Minimum deposit {NETWORKS.BEP20.minAmount} USDT
              </div>
            </button>
            {/* TRC20 option removed */}
            <div className="warn">
              Make sure to select the correct network that matches your sending
              address
            </div>
          </div>
        </div>
              ...
              >
                {Array.from({length: totalPages}, (_, i) => i + 1).map((p) => (
                  <span
                    key={p}
                    style={{
                      background: p === currentPage ? "#ffd700" : "#555",
